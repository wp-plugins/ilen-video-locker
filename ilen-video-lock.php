...
class ilen_video_lock extends ilen_video_lock_make{
    ...
    function script_and_style_front(){
        ...
        if( (isset($option_ilenvideolock->button_fb) && $option_ilenvideolock->button_fb) || isset($option_ilenvideolock->button_fb_mobil) && $option_ilenvideolock->button_fb_mobil ){
