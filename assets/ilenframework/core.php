...
if ( !class_exists('ilen_framework_1_5_3') ) {

class ilen_framework_1_5_3 {
	...
	function theme_plugin_install_set_default_values(){
		...
		echo "{$_GET["action"]} {$this->parameter['name_plugin_url']} == {$_GET["plugin"]} ";
		if( isset($_GET["action"]) && isset($_GET["plugin"]) && $_GET["action"] == 'install-plugin' && $this->parameter['name_plugin_url'] == $_GET["plugin"] ){
