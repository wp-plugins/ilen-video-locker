...
class ilen_video_lock_make{
    ...
    ${'tabs_plugin_' . $this->parameter['name_option']}['tab01']=array('id'=>'general','name'=>'General','icon'=>'','link'=>$url,'columns'=>2,'sidebar-file'=> plugin_dir_path( __FILE__ ).'/sidebar-general.php' );
